    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Here's your teaching overview</p>
            </div>
            <div>
                <span class="badge bg-info fs-6"><?= date('F d, Y') ?></span>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h2 class="fw-bold mb-0"><?= esc($myCoursesCount) ?></h2>
                                <p class="mb-0 opacity-75">My Courses</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm h-100 bg-success text-white">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h2 class="fw-bold mb-0"><?= esc($totalStudents) ?></h2>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0 opacity-75">Teaching Status</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-white border-0 py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= base_url('instructor/my-courses') ?>" class="btn btn-sm btn-outline-info">Manage All</a>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        ...
                        <?php else: ?>
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted mb-2">No courses created yet</p>
                                <a href="<?= base_url('instructor/my-courses') ?>" class="btn btn-info btn-sm">Create Course</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-white border-0 py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= base_url('instructor/students') ?>" class="btn btn-sm btn-outline-success">View All</a>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <?php if (!empty($recentEnrollments)): ?>
                            <div class="list-group list-group-flush">
                                <?php foreach (array_slice($recentEnrollments, 0, 4) as $enrollment): ?>
                                    <div class="list-group-item border-0 py-3">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="flex-grow-1 me-3">
                                                <h6 class="mb-1 fw-semibold"><?= esc($enrollment['student_name']) ?></h6>
                                                <small class="text-muted">Enrolled in <?= esc($enrollment['course_title']) ?></small>
                                                <br>
