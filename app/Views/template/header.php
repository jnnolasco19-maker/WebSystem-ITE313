...
<div class="sidebar">
    ...
    <a href="<?= base_url('admin/users?role=instructor') ?>">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="me-2" viewBox="0 0 16 16">
...
<!-- FIXED LEFT SIDEBAR -->
<div class="sidebar" style="background: linear-gradient(180deg, #0dcaf0 0%, #0aa2c0 100%);">
...
<?php if (session()->get('user_role') === 'student'): ?>
  <!-- FIXED LEFT SIDEBAR -->
  <div class="sidebar" style="background: linear-gradient(180deg, #198754 0%, #146c43 100%);">
      ...
      <a href="<?= base_url('student/browse') ?>">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="me-2" viewBox="0 0 16 16">
